...
docker exec -it swissrpg-compile-container /bin/bash -lc 'cd /opt/bot && cargo build --release --target-dir /tmp/target && cp /tmp/target/release/swissrpg-discord-bot /opt/'