...
docker exec -it swissrpg-compile-container /bin/bash -lc 'cd /opt/bot && cargo build --features "bottest" --target-dir /tmp/target && cp /tmp/target/debug/swissrpg-discord-bot /opt/swissrpg-discord-bot-test'